...
const eventConsumer = new KafkaEventConsumer(kafkaConsumer, logger)

const liveBallEventHandler = new LiveBallEventHandler(logger)

export {eventProducer, eventConsumer, liveBallEventHandler}
